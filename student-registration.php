...
$pin = rand(100,999);
$ret=mysqli_query($con,"insert into students(studentName,StudentRegno,password,emailid,pin) values('$studentname','$studentregno','$password','$emailid','$pin')");
if($ret)
{
echo '<script>alert("Student Registered Successfully. pin is "+"'.$pin.'")</script>';
